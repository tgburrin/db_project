...
typedef bool (*message_handler_f)(
		cJSON *,  // client message
		cJSON **, // server response
		uint16_t, // handler arg count
		void **,  // handler args
		char *,   // error message
